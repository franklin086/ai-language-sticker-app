...
import { getNationalNpc, getNationalNpcProgressMessage } from '../utils/nationalNpcHelpers';

export function NationalNpcCard({
  countryId,
  percent,
}: {
  countryId: string;
  ...
  const message = getNationalNpcProgressMessage({ countryId, percent });
