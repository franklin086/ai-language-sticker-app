...
export const museumArtifacts: MuseumArtifact[] = [
  { objectZh: '汽车', objectEn: 'Car', emoji: '🚗', museum: '交通博物馆', rarity: '稀有', story: '汽车帮助人们更快到达远方，也让城市道路和旅行方式发生了变化。', aliases: ['car', 'auto', 'automobile', 'vehicle', 'sedan', 'SUV', 'toy car', '小汽车', '轿车', '车辆', '奔驰', '宝马', '特斯拉', '汽车'], nameTranslations: { zh: '汽车', en: 'Car', es: 'Auto', pt: 'Carro', ja: '車' }, descriptionTranslations: { zh: '帮助人们在城市和远方之间移动的交通工具。', en: 'A vehicle that helps people move through cities and travel farther.', es: 'Un vehículo que ayuda a moverse por la ciudad y viajar más lejos.', pt: 'Um veículo que ajuda as pessoas a circular pela cidade e viajar mais longe.', ja: '街や遠くへ移動するのを助ける乗り物。' } },
  ...
  { objectZh: '火箭', objectEn: 'Rocket', emoji: '🚀', museum: '交通博物馆', rarity: '传奇', story: '火箭用强大的推力冲向天空，把卫星、探测器和宇航员送向太空。', aliases: ['rocket', 'space rocket', 'spaceship', 'spacecraft', 'launch vehicle', '火箭模型', '宇宙飞船', '航天器', '长征火箭', '火箭', '运载火箭'], nameTranslations: { zh: '火箭', en: 'Rocket', es: 'Cohete', pt: 'Foguete', ja: 'ロケット' }, descriptionTranslations: { zh: '用强大推力飞向太空的探索工具。', en: 'A powerful explorer that flies into space with strong thrust.', es: 'Un explorador poderoso que vuela al espacio con gran impulso.', pt: 'Um explorador poderoso que voa ao espaço com grande impulso.', ja: '強い推進力で宇宙へ飛ぶ探検の乗り物。' } },
  { objectZh: '熊猫', objectEn: 'Panda', emoji: '🐼', museum: '动物博物馆', rarity: '传奇', story: '熊猫主要生活在中国山区，爱吃竹子，是许多孩子认识自然和中国动物的第一位朋友。', aliases: ['panda', 'giant panda', 'panda bear', 'black and white bear', '熊猫玩偶', '大熊猫', '黑白熊猫', '中国熊猫', '熊猫'], nameTranslations: { zh: '熊猫', en: 'Panda', es: 'Panda', pt: 'Panda', ja: 'パンダ' }, descriptionTranslations: { zh: '生活在中国山区、喜欢吃竹子的珍稀动物。', en: 'A rare animal from China that loves bamboo and mountain forests.', es: 'Un animal raro de China que ama el bambú y los bosques de montaña.', pt: 'Um animal raro da China que adora bambu e florestas de montanha.', ja: '中国の山にすみ、竹と森が好きなめずらしい動物。' } },
  ...
  { objectZh: '相机', objectEn: 'Camera', emoji: '📷', museum: '科技博物馆', rarity: '稀有', story: '相机把一瞬间保存成照片，让旅行、家人、艺术和新发现都能被记住。', aliases: ['camera', 'photo camera', 'digital camera', 'DSLR', 'photography', '照相机', '拍照设备', '数码相机', '摄影机', '相机'], nameTranslations: { zh: '相机', en: 'Camera', es: 'Cámara', pt: 'Câmera', ja: 'カメラ' }, descriptionTranslations: { zh: '把重要瞬间保存成照片的影像工具。', en: 'An imaging tool that saves important moments as photos.', es: 'Una herramienta de imagen que guarda momentos importantes como fotos.', pt: 'Uma ferramenta de imagem que guarda momentos importantes como fotos.', ja: '大切な瞬間を写真として残す映像の道具。' } },
  ...
  { objectZh: '蒙娜丽莎', objectEn: 'Mona Lisa', emoji: '🖼️', museum: '卢浮宫魔法馆', rarity: '传奇', story: '蒙娜丽莎是达芬奇创作的著名肖像画。她神秘的微笑让世界各地的人都想走近看看。', aliases: ['Mona Lisa painting', 'La Gioconda', 'Leonardo portrait', 'Da Vinci painting', 'portrait painting', '达芬奇肖像', '达芬奇画作', '神秘微笑', '肖像画', 'mona lisa', '蒙娜丽莎', '蒙娜丽莎画作', '达芬奇名画'], nameTranslations: { zh: '蒙娜丽莎', en: 'Mona Lisa', es: 'Mona Lisa', pt: 'Mona Lisa', ja: 'モナ・リザ' }, descriptionTranslations: { zh: '一幅因神秘微笑而闻名世界的肖像画。', en: 'A world-famous portrait known for its mysterious smile.', es: 'Un retrato mundialmente famoso por su sonrisa misteriosa.', pt: 'Um retrato famoso no mundo todo por seu sorriso misterioso.', ja: '神秘的な微笑みで世界的に有名な肖像画。' } },
