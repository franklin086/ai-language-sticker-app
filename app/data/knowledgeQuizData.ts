...
export const knowledgeQuizData: KnowledgeQuizQuestion[] = [
  makeQuestion({
    ...
    zh: '熊猫最有代表性的食物是什么？',
    en: 'What food are pandas famous for eating?',
    es: '¿Qué alimento comen mucho los pandas?',
    pt: 'Qual alimento os pandas comem muito?',
    ja: 'パンダがよく食べるものは何ですか？',
  }),
  makeQuestion({
    artifactKey: 'cat',
  ...
  makeQuestion({
    ...
    zh: '汽车主要怎样改变生活？',
    en: 'How do cars mainly change daily life?',
    es: '¿Cómo cambian los autos la vida diaria?',
    pt: 'Como os carros mudam a vida diária?',
    ja: '自動車は生活をどう変えますか？',
  }),
  makeQuestion({
    artifactKey: 'cup',
  ...
  makeQuestion({
    ...
    zh: '火箭可以把卫星和宇航员送到哪里？',
    en: 'Where can rockets carry satellites and astronauts?',
    es: '¿A dónde pueden llevar los cohetes satélites y astronautas?',
    pt: 'Para onde foguetes podem levar satélites e astronautas?',
    ja: 'ロケットは人工衛星や宇宙飛行士をどこへ運びますか？',
  }),
  makeQuestion({
    artifactKey: 'camera',
    correct: { zh: '保存瞬间', en: 'Save moments', es: 'Guardar momentos', pt: 'Guardar momentos', ja: '瞬間を残す' },
    zh: '相机能帮助我们保存什么？',
    en: 'What can a camera help us save?',
    es: '¿Qué puede guardar una cámara?',
    pt: 'O que uma câmera pode guardar?',
    ja: 'カメラは何を残せますか？',
  }),
  makeQuestion({
    ...
    zh: '蒙娜丽莎最著名的特点是什么？',
    en: 'What is the Mona Lisa famous for?',
    es: '¿Por qué es famosa la Mona Lisa?',
    pt: 'Por que a Mona Lisa é famosa?',
    ja: 'モナ・リザで有名なものは？',
  }),
  makeQuestion({
